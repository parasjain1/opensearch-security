...
public class StreamableRegistry {
    ...
    protected void registerStreamable(Class<?> clazz, Writeable.Writer<Object> writer, Writeable.Reader<Object> reader) {
    ...
    private void registerAllStreamables() {
        ...
        // InetSocketAddress
        this.registerStreamable(InetSocketAddress.class, (Writeable.Writer<Object>) (o, v) -> {
